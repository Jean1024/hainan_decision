...
define(
    'zrender/shape/circle1',['require','./base','../shape'],function(require) {
        function Circle1() {
            this.type = 'circle1';
        }
        ...
        Circle1.prototype =  {
            brush: function(ctx, e, isHighlight){
              this.conf = e;
              base.brush.call(this,ctx, e, isHighlight);
            },
            /**
             * 创建圆形路径
             * @param {Context2D} ctx Canvas 2D上下文
            ...
            buildPath : function(ctx, style) {
                ...
                div.style.left = style.x + 'px';
                div.style.top = style.y + 'px';
                div.style.borderRadius = style.r * 2 + 'px';
                div.style.width = div.style.height = style.r + 'px';
                ...
                div.onclick = function(e){
                  ...
                  var clickEvent = conf.onclick;
                  clickEvent && clickEvent(eventPackage);
                }
        ...
        shape.define('circle1', new Circle1());
        ...
        function Storage(shape) {
            ...
            function del(shapeId) {
                if (typeof shapeId != 'undefined') {
                    ...
                    /*zk add*/
                    var eles = [].slice.call(document.getElementsByTagName('circle'));
                    var temp;
                    while (temp = eles.pop()){
